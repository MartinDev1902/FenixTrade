        ...
        <div class="row trust__items align-items-start">
            <div class="col-3 text-center">
                <div class="trust__item content-block animate fade-up">
                    ...
                    <h3>Authorised and regulated</h3>
                    <p>Fenix Trade is authorised and regulated by the Cyprus Securities and Exchange Commission (Licence No. 250/14)</p>
                </div>
            </div>
            <div class="col-3 text-center">
                <div class="trust__item content-block animate fade-up">
                    ...
                    <h3>Listed on the LSE Main Market</h3>
                    <p>Fenix Trade is a FTSE 250 company listed on the London Stock Exchange’s Main Market for Listed Companies.</p>
                </div>
            </div>
            <div class="col-3 text-center">
                <div class="trust__item content-block animate fade-up">
                    ...
                    <p>Your funds are kept in segregated bank accounts.</p>
                </div>
            </div>
            <div class="col-3 text-center">
                <div class="trust__item content-block animate fade-up">
